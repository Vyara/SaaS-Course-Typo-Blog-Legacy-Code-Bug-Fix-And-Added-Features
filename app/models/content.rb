...
class Content < ActiveRecord::Base
  ...
  def self.merge_articles(merger, merged)
      article1 = Article.find_by_id(merger)
      article2 = Article.find_by_id(merged)
      @new = Article.new(:description => article1.body + article2.body, :postid =>article1.id.to_s)
  end
